...
const styles = `
  ...
  .rfx-head { display:flex; flex-wrap:wrap; align-items:center; justify-content:space-between; gap:12px; margin-bottom: 24px; }
  .rfx-title { font-size: clamp(20px, 4vw, 30px); font-weight: 800; color:#ffffff; letter-spacing:-0.5px; }
  .rfx-actions { display:flex; gap:8px; flex-wrap:wrap; justify-content:flex-end; }
  .rfx-input { min-width: 220px; border-radius:12px; padding:12px 14px; font-size:16px; color:#010101; background: rgba(255,255,255,.98); border:1px solid rgba(15,23,42,.10); outline:none; transition: box-shadow .15s ease, border-color .15s ease, background .15s ease; }
  .rfx-input:focus { border-color: #3aacd6; box-shadow: 0 0 0 4px rgba(58,172,214,.25); background: #ffffff; }
  .rfx-btn { appearance:none; border:1px solid #3aacd6; border-radius:12px; padding:10px 12px; font-weight:700; background: #010101; color:#ffffff; cursor:pointer; display:inline-flex; align-items:center; gap:8px; box-shadow: 0 10px 22px rgba(0,0,0,.35); transition: transform .15s ease, box-shadow .15s ease, background .15s ease, color .15s ease; }
  ...
  .rfx-pill { padding:6px 10px; border-radius:999px; background: rgba(58,172,214,.15); border:1px solid #3aacd6; font-size:12px; margin-left:8px; font-weight:600; color:#ffffff; }
