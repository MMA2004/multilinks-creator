...
export default function Login() {
    ...
    return (
        ...
        .toggle-pwd { 
          ...
          background: transparent; border: 0; cursor: pointer; font-weight: 700; color: #0f172a;
          opacity: .7;
        }
        ...
        .error { background: rgba(239,68,68,.18); border: 1px solid rgba(239,68,68,.55); color: #fee2e2; padding: 10px 12px; border-radius: 12px; font-size: 14px; }
            ...
            <div className="card">
                <div className="brand">
                    ...
                    <div>
                        ...
                        <div className="subtitle">Accede a tu panel para gestionar tus multilinks.</div>
                    </div>
                </div>
